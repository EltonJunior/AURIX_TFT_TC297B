...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED_D00    &MODULE_P02,0                                           /* P02,0 : Port, Pin definition       */
#define BUTTON     &MODULE_P02,1                                           /* P02,1 : Port, Pin definition       */

#define WAIT_TIME   5000                                                     /* Wait time constant in milliseconds   */
